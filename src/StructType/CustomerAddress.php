...
class CustomerAddress extends AbstractStructBase
{
     ...
     */
    public function __construct(int $countryCode, int $customerCenterNumber, int $customerNumber, ?string $title = null, ?string $name0 = null, ?string $name1 = null, ?string $name2 = null, ?string $name3 = null, ?string $countryPrefix = null, ?string $zipCode = null, ?string $city = null, ?string $street = null, ?string $houseNumber = null, ?string $houseNumberExtension = null, ?string $floor = null, ?string $postOfficeBox = null, ?string $phoneNumber = null, ?string $faxNumber = null, ?string $mobileNumber = null, ?string $email = null)
    {
        $this
