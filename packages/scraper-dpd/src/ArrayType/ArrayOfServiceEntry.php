...
class ArrayOfServiceEntry extends AbstractStructArrayBase
{
     ...
     */
    protected ?array $ServiceEntry = null;
     ...
     */
    public function __construct(?array $serviceEntry = null)
    {
        $this
     ...
     *
     * @return array<\Scraper\ScraperDPD\StructType\ServiceEntry>
     */
    public function getServiceEntry(): ?array
    {
        return $this->ServiceEntry ?? null;
    }

    /**
     * This method is responsible for validating the value(s) passed to the setServiceEntry method
     ...
     */
    public static function validateServiceEntryForArrayConstraintFromSetServiceEntry(?array $values = []): string
    {
        if (!\is_array($values)) {
            return '';
        }
     ...
     */
    public function setServiceEntry(?array $serviceEntry = null): self
    {
        // validation for constraint: array
        if ('' !== ($serviceEntryArrayErrorMessage = self::validateServiceEntryForArrayConstraintFromSetServiceEntry($serviceEntry))) {
     ...
     */
    public function current(): ?\Scraper\ScraperDPD\StructType\ServiceEntry
    {
     ...
     * @param int $index
     */
    public function item($index): ?\Scraper\ScraperDPD\StructType\ServiceEntry
    {
     ...
     */
    public function first(): ?\Scraper\ScraperDPD\StructType\ServiceEntry
    {
        return parent::first();
    }
     ...
     */
    public function last(): ?\Scraper\ScraperDPD\StructType\ServiceEntry
    {
        return parent::last();
    }
     ...
     * @param int $offset
     */
    public function offsetGet($offset): ?\Scraper\ScraperDPD\StructType\ServiceEntry
    {
     ...
     *
     * @param \Scraper\ScraperDPD\StructType\ServiceEntry $item
     *
     * @throws \InvalidArgumentException
     */
